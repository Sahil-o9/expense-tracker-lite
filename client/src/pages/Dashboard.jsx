...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-100 dark:bg-[#0F172A] text-slate-800 dark:text-slate-100 flex flex-col md:flex-row">
      {/* Toast Notification (Guaranteed Visibility in Light & Dark Mode) */}
      {toast && (
        <div className="fixed top-6 right-6 z-[9999] transition-all">
          <div
            ...
            style={{
              ...
              borderColor: toast.type === 'error' ? '#b91c1c' : '#047857',
              color: '#ffffff',
            }}
          >
            ...
            <button
              ...
              className="ml-2 bg-transparent border-none p-0 cursor-pointer text-xs font-bold leading-none"
